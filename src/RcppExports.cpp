...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(lassoSampler(initEst, initSamp, oneCov, XmX, XmXinv, condSigma, lambda, ysigsq, zeroMean, sqrtZero, u0mat, n, p, nsamp, burnin, Xy, estimateMat, sampMat, delay, stepRate, stepCoef, gradientBound, assumeConvergence, naive, methodExact, verbose, multiThread));
...
static const R_CallMethodDef CallEntries[] = {
    {"_selectiveMLE_lassoSampler", (DL_FUNC) &_selectiveMLE_lassoSampler, 27},
